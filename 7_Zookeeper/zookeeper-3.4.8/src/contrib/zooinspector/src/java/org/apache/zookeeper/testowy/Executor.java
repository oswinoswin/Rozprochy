package org.apache.zookeeper.testowy;
...
public class Executor
    ...
    static String path = "/znode_testowy";
    static int childrenCount;
    int currChildrenCount = -1;

    public Executor(String host, String znode,
                    String exec[]) throws KeeperException, IOException {
        this.exec = exec;
        zk = new ZooKeeper(host, 2181, this);
        dm = new DataMonitor(zk, znode, null, this);
        try {
            childrenCount = zk.getChildren(path, false).size();
    ...
    void printChildren(String name, String curr_path, String format){
        ...
        try {
            ...
            for (String child_name: children){
                //System.out.println("\t\\/"+ child_name); //Print children's
